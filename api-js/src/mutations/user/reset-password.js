...
const resetPassword = (i18n) =>
  new mutationWithClientMutationId({
    name: 'ResetPassword',
    description: i18n._(
      t`This mutation allows the user to take the token they received in their email to reset their password.`,
    ),
    inputFields: () => ({
      password: {
    ...
    mutateAndGetPayload: async (
      ...
      if (password !== confirmPassword) {
        ...
        throw new Error(
          i18n._(t`New passwords do not match. Please try again.`),
        )
      }
