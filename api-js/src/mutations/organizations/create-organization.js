...
const { Acronym, TranslatedString } = require('../../scalars')
const { organizationType } = require('../../types')

const createOrganization = (i18n) =>
  new mutationWithClientMutationId({
    name: 'CreateOrganization',
    description: i18n._(
      t`This mutation allows the creation of an organization inside the database.`,
    ),
    inputFields: () => ({
      acronymEN: {
        type: GraphQLNonNull(Acronym(i18n)),
